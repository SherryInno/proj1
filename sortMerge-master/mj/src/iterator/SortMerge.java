...
public class SortMerge extends Iterator implements GlobalConst
{
  ...
  public SortMerge(AttrType    in1[],               
	...
	throw new TupleUtilsException (e, "Exception is caught by SortMerge.java");
      ...
      if    (!in1_sorted){
	try {
	  am1 = new Sort(in1, (short)len_in1, s1_sizes, am1, join_col_in1,
      ...
      if (! in2_sorted){
	try {
	  am2 = new Sort(in2, (short)len_in2, s2_sizes, am2, join_col_in2,
	  ...
	  if (process_next_block)
	    {
	      ...
	      if (get_from_in1)
		if ((tuple1 = am1.get_next()) == null)
		  {
		    done = true;
		    return null;
		  }
	      if (get_from_in2)
		if ((tuple2 = am2.get_next()) == null)
		  {
		    done = true;
		    return null;
		  }
